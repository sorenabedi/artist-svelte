...
<AvatarStack>
	<Avatar color="default" alt="Some Text" image={'/images/avatar-1.png'} />
	<Avatar color="primary" alt="Some Text" image={'/images/avatar-2.png'} />
	<Avatar color="secondary" alt="Some Text" image={'/images/avatar-3.png'} />
	<Avatar color="success" alt="Some Text" image={'/images/avatar-4.png'} />
	<Avatar color="warning" alt="Some Text" image={'/images/avatar-5.png'} />
	<Avatar color="danger" alt="Some Text" image={'/images/avatar-6.png'} />
	<Avatar color="info" alt="Some Text" image={'/images/avatar-7.png'} />
</AvatarStack>

<Avatar color="default" alt="Some Text" text="JD" />
<Avatar color="primary" alt="Some Text" text="SA" />
<Avatar color="secondary" alt="Some Text" text="FE" />
<Avatar color="success" alt="Some Text" text="GY" />
...
<Avatar color="default" alt="Some Text" image={'/images/avatar-1.png'} />
<Avatar color="default" alt="Some Text" image={'/images/avatar-2.png'} />
...
<AvatarStack>
	<Avatar color="default" alt="Some Text" bordered text="EC" />
	<Avatar color="primary" alt="Some Text" bordered text="MG" />
	<Avatar color="secondary" alt="Some Text" bordered text="RW" />
	<Avatar color="success" alt="Some Text" bordered text="MR" />
	<Avatar color="warning" alt="Some Text" bordered text="BL" />
	<Avatar color="danger" alt="Some Text" bordered text="PA" />
	<Avatar color="info" alt="Some Text" bordered text="SA" />
</AvatarStack>
