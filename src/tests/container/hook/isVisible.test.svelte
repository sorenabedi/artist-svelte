...
<button data-testid="initCheck" on:click={check} />
<div data-testid="Visible">{visibleStatus}</div>
<div style="display: block;height: 150vh" />

<div data-testid="Hidden">{hiddenStatus}</div>
